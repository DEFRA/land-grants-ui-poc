  ...
  describe.each([{
    ...
    describe('Form preview', () => {
      beforeEach(() => {
        const {
          container
        } = renderView('partials/preview-banner.html', {
          context: {
            previewMode: status,
            context: {
              isForceAccess: false,
      ...
      it('should have text content', () => {
        expect($paragraphs[0]).toHaveTextContent(`This is a preview of a ${status} form. Do not enter personal information.`);
      });
    });
    describe('Preview URL direct access', () => {
      ...
      it('should have text content', () => {
        expect($paragraphs[0]).toHaveTextContent(`This is a preview of a ${status} form page you are editing.`);
    ...
    describe('Preview URL direct access (with previous pages)', () => {
      ...
      it('should have text content', () => {
        expect($paragraphs[0]).toHaveTextContent(`This is a preview of a ${status} form page you are editing.`);
        expect($paragraphs[1]).toHaveTextContent('It depends on answers from earlier pages in the form. In the live version, users will need to complete those questions first.');
      });
    });
  });
});
//# sourceMappingURL=preview-banner.test.js.map